...
//    private static String mCookie;
    ...
    public GsonPostUTF8Request(String url, Class<T> clazz, Map<String, String> params, Listener<T> listener, ErrorListener errorListener) {
        this(url, clazz, null, params, listener, errorListener);
    }

    public GsonPostUTF8Request(String url, Class<T> clazz, Map<String, String> headers, Map<String, String> params, Listener<T> listener, ErrorListener errorListener) {
